...
class Artfestival extends CI_Controller
{
	var $tablefunc = 'artfestival';
	var $fields = array('category','title','keywords','description','content','group','notice','copyfrom','fromlink','thumb','color','isbold','hits','tpl','listorder','status');
	...
	function __construct(){
		...
		$this->categoryarr = mult_to_single($this->Data_model->getData(array('isdisabled'=>0,'lang'=>$this->editlang,'model'=>$this->tablefunc,'parent >'=>0),'parent,listorder',0,0,'category'));
