...
<?php elseif($tpl=='view'):?>
	...
	<tr>
		<td>专家团</td>
		<td colspan="5"><textarea style="width:668px;height:300px;" name="group" id="group" class="editor"><?=isset($view['group'])?htmlspecialchars($view['group']):'';?></textarea></td></tr>
	<tr>
		<td>参赛须知</td>
		<td colspan="5"><textarea style="width:668px;height:300px;" name="notice" id="notice" class="editor"><?=isset($view['notice'])?htmlspecialchars($view['notice']):'';?></textarea></td></tr>
	<tr>
		<td><?=lang('tag')?></td>
